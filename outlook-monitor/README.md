...
<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/App_registration.gif" width="800" height="500" />


Give your application a name, Sign-on  URL and click **Create**


<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Create_app.gif" width="300" height="300" />

 
Next you will need to generate a key for you application to use. 
Click **Settings > Keys**

<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Settings_generate_key.gif" width="800" height="500" />


Give your Key a Description and Expiration time and click **Save** to generate the key

<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Keys.gif" width="500" height="200" />
...
<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Required_permission.gif" width="800" height="400" />
...
<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Enable_Access_AzureAD.gif" width="800" height="400" />
...
<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Enable_Access_Graph.gif" width="800" height="900" />

 
Finally you must click **Grant permissions** in order for your choices to take affect.

<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Grant_permissions.gif" width="600" height="300" />
...
<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Heroku_GitHub_deploy.gif" width="900" height="400" />

Under the **Settings** menu, make sure to add in the Config variables. 

<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Heroku_variables.gif" width="800" height="300" />

Back under the **Deploy** menu scroll down the **Manual Deploy** to deploy the application

<img src= "https://github.com/clintmann/outlook-monitor/blob/master/images/Heroku_manual_deploy.gif" width="950" height="300" />
